export const cvData = {
  ...
  contact: {
    ...
    github: "https://github.com/yourusername", // Placeholder as not in CV, but implied by github.io
    location: "Shanghai, China",
    photo: null // Optional: Add a URL to a default photo here if desired
  },
  researchInterests: [
  ...
  education: [
    {
      ...
      location: "Shanghai, China",
      period: "2023 -- Present",
      mentors: "Professor Xipeng Qiu & Wenhao Huang"
    },
    {
  ...
  publications: [
    {
      ...
      venue: "Under Review",
      year: "2025",
      links: { pdf: "https://arxiv.org/abs/your_link_here" }
    },
    {
  ...
  experience: [
    {
      ...
      description: "Research on RL, Evaluation & Syntactic Data"
    },
    {
      company: "Shanghai AI Lab. OpenLMLab",
      role: "InternLM",
      location: "Shanghai, China",
      period: "April 2023 -- January 2024",
      description: "MoE Research & Data Engineering"
    }
  ]
};
